<?php 
    ...
    if(!empty($_SESSION['id'])){
      $query = 'SELECT * FROM  dbse_login  WHERE id ='.$_SESSION['id'];
      $query .= ' AND status = 1 ';
          ...
          <div class="card">
           ...
           <div class="card-body">
            ...
            <table class="table">
              ...
              <tr><th>Email</th><td><input type="text" name="username" value="<?php echo $user_data[0]['email']; ?>" class="form-control" required></td></tr>
