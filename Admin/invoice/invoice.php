...
<body id="print">
	...
	<div id="identity">
      ...
      <a href="../invoice_edit.php?id=<?php echo $_REQUEST['id']; ?>"><button class="btn" id="edit">Edit</button></a>
      <button class="btn" id="print" onclick="print()">Print</button>
      <a href="../model/generic_status.php?id=<?php echo $_REQUEST['id']?>&table=oyester_inquiry&status=PREVIEW&estimation_sent=1&final_amt=<?php echo $total_amt; ?>"<button class="btn" style="text-decoration:none;">Estimation Sent</button></a>
  </div>
