...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="" class="brand-link">
    <img src="dist/img/ovgu_logo.jpeg" style="opacity: 8.8;width: 186px;margin-left: 10%;"> <!--class="brand-image img-circle elevation-3"-->
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="dashboard.php" class="nav-link" id="nav_dashboard">
        ...
        <?php if($_SESSION['role'] == '1') { ?>
        <li class="nav-item">
          <a href="user_dashboard.php" class="nav-link" id="participant_dashboard">
