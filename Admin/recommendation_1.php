        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="recom1" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                  <th>Name</th>
                  <th>Email</th>
...
<script>
  $(function () {
     var dataTable =  $("#recom1").DataTable({
      "responsive": true,
      "autoWidth": false,
      "processing" :true,
      "serverSide" :true,
      ...
      "order" :[],
      "ajax" :{
        url:"model/recommendation1_fetch.php",
        type :"POST"
      },
      "ColumnDefs":[{
        "targets":[0,1,2,3,4],
    ...
    $(document).on('click', '.delete', function(){
      ...
      if(confirm("Are you sure you want to delete the User?"))
      {
       $.ajax({
        ...
        method:"POST",
        data:{id:id,table:'dbse_recommendaton'},
...
<script>
$(function(){
$( "#recommendation_1" ).addClass( "active" );
});
</script>
</body>
</html>