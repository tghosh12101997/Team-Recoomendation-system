...
<head>
  ...
  <title>DBSE | Recommendation</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6>Recommendation Dashboard</h6>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="recom2" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                  <th>id</th>
                  <th>Team</th>
...
<script>
  $(function () {
     var dataTable =  $("#recom2").DataTable({
      "responsive": true,
      "autoWidth": false,
      "processing" :true,
      "serverSide" :true,
      ...
      "order" :[],
      "ajax" :{
        url:"model/recommendation2_fetch.php",
        type :"POST"
      },
      "ColumnDefs":[{
        "targets":[0,1,2],
    ...
    $(document).on('click', '.delete', function(){
      ...
      if(confirm("Are you sure you want to delete the User?"))
      {
       $.ajax({
        ...
        method:"POST",
        data:{id:id,table:'dbse_recommendaton_1'},
...
<script>
$(function(){
$( "#recommendation_2" ).addClass( "active" );
});
</script>
</body>
</html>